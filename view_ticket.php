                ...
                <table class="table table-striped table-secondary table-hover" id="view_table" style="background-color:#f5f5f5" >
                    ...
                    <tbody class="text-capitalize">
                        <?php
                                    ...
                                    $query1=mysqli_query($conn,"update ticket set payment_status='success' where id='$_SESSION[id]'");
                                    $query=mysqli_query($conn,"select * from ticket where id='$_SESSION[id]'");
                                    ...
                                    if(mysqli_num_rows($query)>0)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <a href="print_ticket.php?id=<?php echo "$_SESSION[id]";?>" class="text-white" style="text-decoration:none;" >View</a></button></td>
