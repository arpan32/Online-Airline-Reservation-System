...
<div class="row">
    <div class="col-2 pl-3 left_section">
                ...
                <ul class="nav mt-2 sidebar flex-column">
                    ...
                    <li class="nav-item">
                         <a class="nav-link text-white" href="view_ticket.php"><i class="fa fa-edit"></i>view ticket</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <?php
                                    ...
                                    if(mysqli_num_rows($query)>0)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <a href="payment.php?id=<?php echo $data['id'];?>" class="text-white" style="text-decoration:none;" >Pay</a>
                                            <?php } 
                                            else
                                            {
                                            ?>Paid<?php
